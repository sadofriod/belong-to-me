		...
		mui.plusReady(function() {
			...
			document.querySelector('.mui-icon-bars').addEventListener('tap', function() {
				testUrl = plus.webview.getWebviewById('recommendedInformation.html');
				console.log(testUrl);
				testUrl.evalJS("var mask = mui.createMask(null);mask.show();")
				openMenu();
			})
//
//			closeChild = function() {
//				testUrl = plus.webview.getWebviewById('recommendedInformation.html');
//				console.log(testUrl);
//				testUrl.evalJS("var mask = mui.createMask(null);mask.close();")
//			}
		});
		/**
		 * 显示菜单菜单
